...
#https://api.openweathermap.org/data/2.5/weather?lat={lat}&lon={lon}&appid={API key}
    #api ="api.openweathermap.org/data/2.5/forecast/daily?lat="+str(location.latitude)+"&lon="+str(location.longitude)+"&appid=1f45d110deb33c102e9ed6f11b786d30"
    #weather
    ...
    photo1 = ImageTk.PhotoImage(file=rf"D:\projects\weather App\icon\{firstdayimage}@2x.png")
    firstimage.config(image = photo1)
    firstimage.image=photo1
    
    temday1 = json_data['daily'][0]['temp']['day']
    ...
    img = (Image.open(rf"D:\projects\weather App\icon\{seconddayimage}@2x.png"))
    resized_image = img.resize((50,50))
    photo2 = ImageTk.PhotoImage(resized_image)
    secondimage.config(image=photo2)
    secondimage.image=photo2
    
    temday2 = json_data['daily'][1]['temp']['day']
    ...
    img = (Image.open(rf"D:\projects\weather App\icon\{thirddayimage}@2x.png"))
    resized_image = img.resize((50,50))
    photo3 = ImageTk.PhotoImage(resized_image)
    thirdimage.config(image=photo3)
    thirdimage.image=photo3
    
    temday3 = json_data['daily'][2]['temp']['day']
    ...
    img = (Image.open(rf"D:\projects\weather App\icon\{fourthdayimage}@2x.png"))
    resized_image = img.resize((50,50))
    photo4 = ImageTk.PhotoImage(resized_image)
    fourthimage.config(image=photo4)
    fourthimage.image=photo4
    
    temday4 = json_data['daily'][3]['temp']['day']
    ...
    img = (Image.open(rf"D:\projects\weather App\icon\{fifthdayimage}@2x.png"))
    resized_image = img.resize((50,50))
    photo5 = ImageTk.PhotoImage(resized_image)
    fifthimage.config(image=photo5)
    fifthimage.image=photo5
    
    temday5 = json_data['daily'][4]['temp']['day']
    ...
    img = (Image.open(rf"D:\projects\weather App\icon\{sixthdayimage}@2x.png"))
    resized_image = img.resize((50,50))
    photo6 = ImageTk.PhotoImage(resized_image)
    sixthimage.config(image=photo6)
    sixthimage.image=photo6
    
    temday6 = json_data['daily'][5]['temp']['day']
    ...
    img = (Image.open(rf"D:\projects\weather App\icon\{seventhdayimage}@2x.png"))
    resized_image = img.resize((50,50))
    photo7 = ImageTk.PhotoImage(resized_image)
    seventhimage.config(image=photo7)
    seventhimage.image=photo7
    
    temday7 = json_data['daily'][6]['temp']['day']
...
image_icon = tk.PhotoImage(file=r"C:\Users\loke0\OneDrive\Pictures\weather images\Images\logo.png")
root.iconphoto(False,image_icon)

Round_box = PhotoImage(file='C:\\Users\\loke0\\OneDrive\\Pictures\\weather images\\Images\\Rounded Rectangle 1.png')
...
## search box
Search_image=PhotoImage(file = r"C:\Users\loke0\OneDrive\Pictures\weather images\Images\Rounded Rectangle 3.png")
myimage = Label(image=Search_image,bg="#57adff")
myimage.place(x=270,y=120)



weat_image=PhotoImage(file=r"C:\Users\loke0\OneDrive\Pictures\weather images\Images\Layer 7.png")
...
Search_icon = PhotoImage(file = r"C:\Users\loke0\OneDrive\Pictures\weather images\Images\Layer 6.png")
...
#bottom boxes
firstbox = PhotoImage(file = r"C:\Users\loke0\OneDrive\Pictures\weather images\Images\Rounded Rectangle 2.png")
Secondbox = PhotoImage(file=r"C:\Users\loke0\OneDrive\Pictures\weather images\Images\Rounded Rectangle 2 copy.png")
